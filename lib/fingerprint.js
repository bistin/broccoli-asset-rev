...
function Fingerprint(inputNode, options) {
  ...
  this.prependAssetMap = options.prependAssetMap || "";
  this.appendAssetMap = options.appendAssetMap || "";
...
//   assetMapExtension : "json"
  ...
  this.safeWrite(destDir + '/' + fileName, this.prependAssetMap+contents+ this.appendAssetMap);
